      ...
      <section className="product-details-page">
        ...
        <aside className="info-container">
          <section className="block-image">
            <main>
              <Zoom
                img={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSU2XOh_sxw93Fq1bhCMkx3yCQhrS4Bx0Rukg&s" }
                zoomScale={3}
                width={500}
                height={400}
              />
          ...
          <section className="block-info">
            <aside className='dets'>
              ...
              <h1 className="product-title">Materias e ferramentas  / Kit de manutenção</h1>
