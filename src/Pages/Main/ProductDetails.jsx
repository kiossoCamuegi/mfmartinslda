...
function ProductDetails() {
  ...
  const Images = [
    {
      image: "https://thumbs.dreamstime.com/b/ferramentas-14175290.jpg",
      code:1,
    },
    {
      ...
      <section className="product-details-page">
        ...
        <aside className="info-container">
          <section className="block-image">
            <main>
              <Zoom
                img={"https://thumbs.dreamstime.com/b/ferramentas-14175290.jpg"}
                zoomScale={3}
                width={500}
                height={400}
              />
          ...
          <section className="block-info">
            <aside className='dets'>
              ...
              <h1 className="product-title">Materias de corte  e equipamentos / Kit de manutenção</h1>
